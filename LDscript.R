...
setwd("~/Dropbox/ChromosomeOmy5/Omy5_survey2014/LD_88SNPs")

# Start with 'toolkit' formatted file (.csv), first column called 'Sample_ID'.

x <- read.csv(file="~/Dropbox/ChromosomeOmy5/Omy5_survey2014/LD_88SNPs/Omy5survey2014_88SNPs.csv", na.strings=c("0"))

######                                                  #############
######                                                  #############
######                                                  #############
###### NOTE SUPER IMPORTANT, REMOVE:                    #############
######   OMY28 MARKERS                                  #############
